...
public class TestGhostValidMoves extends TestCase {
	...
	public void testGhostValidMoves() throws FileNotFoundException {
		...
		// Creating Players
		Ghost ghost1 = frame.addGhost(new Location(2, 3), "gibby", Color.red); // Creates a red ghost named "name" at
																				// location x,y
		Ghost ghost2 = frame.addGhost(new Location(3, 3), "bibby", Color.blue); // Creates a red ghost named "name" at
																				// location x,y
		Ghost ghost3 = frame.addGhost(new Location(4, 3), "dibby", Color.pink); // Creates a red ghost named "name" at
																				// location x,y
		Ghost ghost4 = frame.addGhost(new Location(3, 2), "wibby", Color.green); // Creates a red ghost named "name" at
																					// location x,y
